...
throw e;
        ...
        var t = expected.alts.some(function(alt) {
            var ss = alt.params;
...
Vp.expression = function expression(e) {
    return this.match(e, "expression", function(when) {
        ...
        when({
            type: 'MemberExpression',
            left: { type: 'Identifier', name: match.var('x'), loc: match.var('loc') },
            right: { type: 'Literal', value: match.range(0, 0x100000000), raw: dotless }
        }, function(vars) {
        ...
        when({
            ...
            return this.checkArguments(vars.args.map(this.expression, this),
        ...
        when({
            ...
            return vars.es.map(this.expression, this).pop();
        }, this);
